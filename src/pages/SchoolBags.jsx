...
const products = [
  {
    ...
    type: "School",
    description:
      "Comfortable and practical backpacks for students, available in different sizes, designs and colours.",
  ...
  },
  {
    ...
    type: "School",
    description:
      "Fun and comfortable school bags designed for younger students and everyday school use.",
    image: "/images/kids-school-bag.jpg",
  },
  {
    name: "Premium School Bags",
    type: "School",
    description:
      "Spacious school bags with practical storage for books, notebooks and daily essentials.",
    image: "/images/premium-school-bag.jpg",
  },
];
function SchoolBags() {
  return (
...
<p className="mt-5 max-w-2xl text-base leading-7 text-[#6b625b]">
  Explore comfortable and practical school bags in different
  designs, sizes and styles for students and everyday school use.
</p>
            ...
            <div className="rounded-3xl border border-[#eadfd2] bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3 text-sm text-[#6b625b]">
                ...
                <div className="flex items-start gap-3">
                  <span>🎒</span>
                  <span>School bags for students</span>
                </div>

                <div className="flex items-start gap-3">
                  <span>🧳</span>
                  <span>Travel bags & trolley options</span>
                </div>

                <div className="flex items-start gap-3">
                  <span>🎨</span>
                  <span>Different designs and styles</span>
                </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-10">
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-tight md:text-4xl">
              School & Travel Collection
            </h2>

            <p className="mt-3 max-w-2xl text-sm leading-6 text-[#6b625b]">
              Browse our range of bags and ask us about the designs,
                  ...
                  <div className="mt-auto pt-6">
                    ...
                    <a
                      href={`https://wa.me/916392964128?text=${encodeURIComponent(
                        `Hi Dileep Book Store, I'm looking for items from the ${product.name} collection. Please share the available options, designs and current prices.`
                      )}`}
                      target="_blank"
                      rel="noreferrer"
      ...
      <section className="border-t border-[#eadfd2] bg-white px-6 py-20 lg:px-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Ask About Available Bags
          </h2>

          <p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-[#6b625b]">
            Looking for a particular school bag, travel bag or trolley?
            Send us a WhatsApp message and ask about current options,
            sizes and prices.
          </p>

          <a
            href="https://wa.me/916392964128?text=Hi%20Dileep%20Book%20Store%2C%20I%27m%20looking%20for%20a%20school%20bag%2C%20travel%20bag%20or%20trolley.%20Please%20share%20available%20options."
            target="_blank"
            rel="noreferrer"
